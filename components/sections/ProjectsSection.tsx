    ...
    <section id="projects" className="scroll-mt-24 py-16 sm:py-24 relative z-10 bg-[var(--bg-page)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <Badge variant="cyan" size="md" icon={<FolderGit2 className="w-3.5 h-3.5" />}>
          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project) => (
              <motion.div
                ...
                className="flex"
              >
                <GlassCard className="w-full flex flex-col justify-between p-6 space-y-6 group">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <h3 className="text-xl font-bold text-[var(--text-heading)] group-hover:text-sky-500 transition-colors">
                        {project.title}
                      </h3>
