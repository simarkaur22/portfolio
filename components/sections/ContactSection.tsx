    ...
    <section id="contact" className="py-24 relative z-10 bg-[var(--bg-page)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <Badge variant="emerald" size="md" icon={<MessageSquare className="w-3.5 h-3.5" />}>
            Get In Touch
          </Badge>
            ...
            <GlassCard className="p-8 space-y-6">
              ...
              <div className="space-y-4 pt-2">
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl bg-[var(--bg-pill)] border border-[var(--border-subtle)] hover:border-sky-500/40 transition-colors group"
                >
                  <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/30 flex items-center justify-center text-sky-500 group-hover:scale-105 transition-transform">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-[var(--text-muted)] font-mono">Email Address</div>
                    <div className="text-sm font-semibold text-[var(--text-heading)] group-hover:text-sky-500 transition-colors">
                      {personalInfo.email}
                    </div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm font-semibold text-[var(--text-heading)] group-hover:text-emerald-500 transition-colors">
                      {personalInfo.phone}
                    </div>
                  </div>
                </a>

                <div className="flex items-center gap-4 p-4 rounded-xl bg-[var(--bg-pill)] border border-[var(--border-subtle)]">
                  <div className="w-10 h-10 rounded-xl bg-violet-500/10 border border-violet-500/30 flex items-center justify-center text-violet-500">
              ...
              <div className="pt-4 border-t border-[var(--border-subtle)] space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <a
                    ...
                    className="p-3 rounded-xl bg-[var(--bg-pill)] border border-[var(--border-subtle)] text-[var(--text-body)] hover:text-sky-500 hover:border-sky-400/40 transition-all flex items-center gap-2 text-xs font-semibold"
                  >
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-xl font-bold text-[var(--text-heading)]">Message Delivered!</h4>
                    <p className="text-xs sm:text-sm text-[var(--text-body)] leading-relaxed max-w-md mx-auto">
                      Thank you! Your message has been sent directly to <strong>{personalInfo.email}</strong>. I'll review it and get back to you shortly.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2.5 rounded-xl bg-[var(--bg-input)] border border-[var(--border-subtle)] text-[var(--text-heading)] text-sm focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition-colors"
                      />
                    </div>
