...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-16 sm:py-24 relative z-10 bg-[var(--bg-page)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-4">
          <Badge variant="violet" size="md" icon={<UserCheck className="w-3.5 h-3.5 shrink-0" />}>
            About My Profile
          </Badge>
            ...
            <GlassCard className="h-full p-6 sm:p-8 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-[var(--text-heading)]">Laravel & Backend Engineering Background</h3>
                ...
                <div className="space-y-3.5 text-[var(--text-body)] text-sm sm:text-base leading-relaxed">
                  <p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-[var(--border-subtle)]">
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs font-semibold text-sky-600 dark:text-sky-400">
                    <Server className="w-4 h-4 shrink-0" /> Laravel Core
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs font-semibold text-violet-600 dark:text-violet-400">
                    <Cpu className="w-4 h-4 shrink-0" /> AI-Augmented
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-1.5 text-xs font-semibold text-emerald-600 dark:text-emerald-400">
                    <ShieldCheck className="w-4 h-4 shrink-0" /> QA Rigor
                  </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <GlassCard className="p-6 space-y-4">
              <h4 className="text-base font-bold text-[var(--text-heading)] flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-sky-500 shrink-0" /> What I Enjoy Building
              </h4>
            ...
            <GlassCard className="p-6 space-y-4">
              <h4 className="text-base font-bold text-[var(--text-heading)] flex items-center gap-2">
                <GraduationCap className="w-4 h-4 text-violet-500 shrink-0" /> Academic Foundation
              </h4>
